...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.current_ev_chn = 6
        self._C.pretrained_ev_chn = 24

        self._C.TESTING = CN()
        self._C.TESTING.RESUME = True
        self._C.TESTING.RESUME_PATH = None

        self.result_dir='./output'


        self.father_train_path_npz="datasets/HighREV/train/"
        self.father_val_path_npz="datasets/HighREV/val/"
        self.father_test_path_npz="datasets/HighREV/test/"
        self.father_train_voxel_path = "datasets/HighREV/train/"
        self.father_val_voxel_path = "datasets/HighREV/val/"
        self.father_test_voxel_path = "datasets/HighREV/test/"
        ...
        self.recurrent_block_type='convlstm'  # 可以调整
        self.num_encoders=4
