...
from basicsr.models.archs.unet_detail import UNet3d_18
...
class EFNetDetailEnhance(nn.Module):
    def __init__(self, in_chn=3, ev_chn=6, wf=64, depth=3, fuse_before_downsample=True, relu_slope=0.2, num_heads=[1,2,4]):
        ...
        self.enhance = UNet3d_18(bn=False)
    ...
    def forward(self, x, event, mask=None):
        ...
        # 
        out_3 = self.enhance(img0=image, img1=out_2)
        out_3 = out_3 + image
